...
public class CardSoln3 {
    ...
    public static void main(String[] args) {
    		/*Question 15.5.4 - Not sure what counts as good, but my code runs properly!*/
    		...
    		for (Pokerhand hand : hands) {
    			...
    			hand.sort();
    			hand.print();
    			System.out.println(hand.hasFullHouse());
    			System.out.println("");
    		}
    		
    		/*Question 15.5.7
    		 * Runs through 10000 Pokerhands and adds to a running counter of flushes or three of a kinds.
    		 * The flushes averaged at around 20/10000 (.2%), while the 3 of a kind averaged at around 
    		 * 3300/10000 (33%). While the flush probability was around the true probability, the 3 of a 
    		 * kind proportion was way too high.
    		 *
    		int bkflush = 0;
    		int bk3kind = 0;
    		Pokerhand[] hands2 = new Pokerhand[10000];
    		for (Pokerhand newhand : hands2) {
    			Deck d = new Deck();
    			newhand = d.deal();
    			if (newhand.hasFlush()) {
    				bkflush++;
    		...
    		System.out.println("The probability of getting a flush is " + bkflush + "/10000.");
    		System.out.println("The probability of getting three of a kind is " + bk3kind + "/10000.");*/
    }
...
class Deck {
     ...
     * A big flaw with this code is that it inserts null objects into the cards[] array, which then
     * leads to problems with shuffling and dealing cards.
     */
    public Pokerhand deal() {
    		this.shuffle();
    		Pokerhand hand = new Pokerhand();
    		int nullcounter = 0;
    		for (int i = 0; i < Pokerhand.handsize+nullcounter; i++) {
    			if (this.cards[i] == null) {nullcounter++;}
    			else {
